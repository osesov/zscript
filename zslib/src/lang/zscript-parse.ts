...
// @ts-ignore
  ...
  var peg$e117 = peg$classExpectation(["-", "_", "+", "~", "!", "*", "/", "%", "^", "=", "[", "]", "|", "&", "?", ":", "."], false, false);
// @ts-ignore
...
export type ChunkStatement = void;
export type Chunk =
  | [_, IfDirective]
  | [_, IfdefDirective]
  | [_, IfndefDirective]
  ...
  | [_, undefined, EnumDeclaration]
  | [_, undefined, EnumValue];
